...
const BlogPost = ({ content, description, date, image, tags, title }) => {
  return (
    <div className="relative py-16 bg-white overflow-hidden">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="text-lg max-w-prose mx-auto">
          <h1>
            <span className="block text-base text-center text-rtSecondary font-semibold tracking-wide uppercase">
              Blog
            </span>
