...
import javierVillamarinImg from '../../images/about-home-javier.jpeg';
              ...
              <div className="relative px-8">
                ...
                <blockquote className="mt-8">
                  ...
                  <footer className="mt-4">
                    <p className="text-base font-semibold text-rose-200">Javier Villamarín, Coordinador General.</p>
                  </footer>
                </blockquote>
              </div>
            </div>
