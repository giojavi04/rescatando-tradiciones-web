      ...
      <div className="bg-warm-gray-50">
        <div className="py-24 lg:py-32">
          <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
            <ContentHTML content={data.contactDescription} />
          </div>
        </div>
      </div>
          ...
          <div className="relative bg-white shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3">
              <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-rose-500 to-rtSecondary sm:px-10 xl:p-12">
                ...
                <ContentHTML content={data.contactContentForm} />
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-white">
                    ...
                    <span className="ml-3">{data.contactPhone}</span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-white">
                    ...
                    <span className="ml-3">{data.contactMail}</span>
                  </dd>
                </dl>
                <ul className="mt-8 flex space-x-12">
                  <li>
                    <a className="text-white hover:text-gray-100" href="https://www.facebook.com/RescatandoT" target="__blank">
                  ...
                  <li>
                    <a className="text-white hover:text-gray-100" href="https://www.instagram.com/rescatando_tradiciones_oficial/" target="__blank">
